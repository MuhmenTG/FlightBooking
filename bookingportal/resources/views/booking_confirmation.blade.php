<!DOCTYPE html> <html> <head> <title>Booking Complete Details</title> </head> <body> <style> .container { border: 1px
solid #ddd; padding: 10px; margin-bottom: 20px; } </style>
...
<div class="container">
    ...
    <p>
        <strong>Departure:</strong> {{ $segment['departureFrom'] }} - {{
...
<p>
<strong>Payment Amount:</strong> {{ $bookingComplete['payment']['paymentAmount'] }} {{
$bookingComplete['payment']['paymentCurrency'] }}
</p>
<p>
