...
//      protected $guarded = [];
        ...
        public function getHotelOfferId() {
                return $this->hotelOfferId;
        }

        public function setHotelOfferId($value) {
                $this->hotelOfferId = $value;
        }
        ...
        public function setPoliciesCheckInOutCheckOut($value) {                $this->policiesCheckInOutCheckOut = $value;    
        }
